...
var calc = function calc(calcForm) {
  ...
  var windowViewType = document.querySelectorAll('#view_type');
  var windowCheckbox = document.querySelectorAll('.checkbox');
  windowWidth.forEach(function (elem) {
    ...
    selector.forEach(function (item, i) {
      item.addEventListener(event, function () {
        if (item.type === "select-one") {
          // вибір матеріалу профілю
          calcForm[prop] = item.value;
          console.log(calcForm);
        } else if (item.type === "checkbox") {
          // вибір тип профілю холодний/теплий
          selector.forEach(function (elem, b) {
            elem.checked = false;
          ...
          // введення ширини та довжини віконнох рами
          calcForm[prop] = i + 1;
          console.log(calcForm);
        }
      });
...
var forms = function forms(a) {
  ...
  var input = document.querySelectorAll('input[name="user_phone"]');
...
var modals = function modals() {
  ...
  openModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', true); // callModalTimer('.popup', 3000);
};
...
var tabs = function tabs() {
  function openTab(tabsHeaderClass, tabsItemClass, tabsBodyClass, addActiveClass) {
    ...
    var tabsHeader = document.querySelector(".".concat(tabsHeaderClass));
    var tabsItem = document.querySelectorAll(".".concat(tabsItemClass));
    var tabsBody = document.querySelectorAll(".".concat(tabsBodyClass));
